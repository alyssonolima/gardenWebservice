...
/* DBMS name:      MySQL 5.0                                    */
/* Created on:     04/10/2015 00:11:12                          */
/*==============================================================*/
...
(
   ...
   MAC1					varchar(10) null default ' ' comment 'Column that stores the information of mac 1.',   
   MAC2					varchar(10) null default ' ' comment 'Column that stores the information of mac 2.',
   primary key (ID_POT)
);
...
alter table USER_CONFIG add constraint FK_REFERENCE_7 foreign key (ID_USER)
      references USER_GARDEN (ID_USER) on delete restrict on update restrict;
